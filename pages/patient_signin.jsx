      ...
      <div className='flex flex-col items-center justify-center w-full flex-2 px-20 text-center'>
        <div className='bg-white rounded-2xl shadow-2xl flex w-2/3 max-w-4xl'>
          <div className='w-3/5 p-5'>
            <div className='py-10'>
              ...
              <div className='flex flex-col items-center'>
                ...
                <a href='#' className='border-2 border-blue-500 text-blue-500 rounded-full px-11 py-1 font-semibold hover:bg-blue-500 hover:text-white'>Sign In</a>
              </div>
            </div>
          </div>
          ...
          <div className='w-2/5 bg-blue-500 text-white rounded-tr-2xl rounded-br-2xl py-36 px-16 mb-2'>
            ...
            <a href='#' className='border-2 border-white rounded-full px-11 py-1 font-semibold hover:bg-white hover:text-blue-500'>Sign up</a>
          </div>
        </div>
      </div>
    </div>
