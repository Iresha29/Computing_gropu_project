              ...
              <div className='border-2 w-10 border-blue-500 inline-block mb-2'></div>
                ...
                <div className='flex flex-col items-center'>
                  ...
                  <div className='bg-gray-100 w-64 p-2 flex items-center mb-3'>
                    ...
                    <input type='text' name='patientnic' placeholder='NIC' className='bg-gray-100 outline-none text-sm'/>
                  </div>
                  <div className='bg-gray-100 w-64 p-2 flex items-center mb-3'>
                    <CiCalendarDate className='text-gray-400 m-2'/>
                    <input type='text' name='dob' placeholder='Date of Birth' className='bg-gray-100 outline-none text-sm'/>
                  </div>
                  <div className='bg-gray-100 w-64 p-2 flex items-center mb-3'>
                    <MdLocationCity className='text-gray-400 m-2'/>
                    <input type='text' name='city' placeholder='City' className='bg-gray-100 outline-none text-sm'/>
                  </div>
                  <div className='bg-gray-100 w-64 p-2 flex items-center mb-3'>
